...
<script>
	$("#sign-firstname, #sign-lastname, #sign-email, #sign-day, #sign-month, #sign-year, #sign-gender, #sign-password, #sign-Cpassword").removeClass("input-error");
	...
	if (errorEmpty == true) {
		$("#sign-firstname, #sign-lastname, #sign-email, #sign-day, #sign-month, #sign-year, #sign-gender, #sign-password, #sign-Cpassword").addClass("input-error");
	}
	...
	if (errorEmpty == false && errorEmail == false && errorUserTaken == false && errorPassword == false && errorPasswordlength == false) {
		$("#sign-firstname, #sign-lastname, #sign-email, #sign-day, #sign-month, #sign-year, #sign-gender, #sign-password, #sign-Cpassword").val("");
		$("#sign-firstname, #sign-lastname, #sign-email, #sign-day, #sign-month, #sign-year, #sign-gender, #sign-password, #sign-Cpassword").addClass("input-success");
	}
</script>